...
import { AuthConstants, UserInfo } from "../../shared/utilities/GlobalConstrants";
              ...
              <div className="header-right">
                ...
                <div className="profile-box ml-15">
                  ...
                  >
                    <div className="profile-info">
                      <div className="info">
                        ...
                        {/* <div className="image">
                          <img
                            src="/assets/images/profile/profile-image.jpg"
                            alt=""
                          />
                  ...
                  <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                    ...
                    {/* <li>
                      <Link to="/playground">
                        <i className="lni lni-user"></i> Play Ground
                      </Link>
                    </li>
                    <li>
                      <a href="#0">
...
//   authentication: state.AuthenticationReducer !== 'undefined' &&
...
// export default connect(mapStateToProps, { Logout: Logout })(withRouter(Header))
export default connect(null, { Logout: Logout })(withRouter(Header))
