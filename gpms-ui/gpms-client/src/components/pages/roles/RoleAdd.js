...
export class RoleAdd extends Component {
  ...
  handleSubmit = async (e) => {
    ...
    const res = await RoleService.Add(model, resToken.token);
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="input-style-1">
                          ...
                          <input type="text" name="name" id="name" value={name} onChange={this.handleInputChange} autoComplete='off'/>
...
export default withAuth(withRouter(RoleAdd));
