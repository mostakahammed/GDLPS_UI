...
export class TransferAdd extends Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit = async (e) => {
        ...
        if (res.response.isSuccess) {
            ...
            this.props.navigate(`/transfer`, { replace: true });
            return;
        }
        ...
        return (
            <Fragment>
                <div className="container-fluid">
                    <Breadcrumb
                        BreadcrumbParams={{
                            header: "Model Wise Transfer Requisition",
                            title: "Model Wise Transfer Add",
                            isDashboardMenu: false,
                            isThreeLayer: true,
                            threeLayerTitle: "Requisitions",
                            threeLayerLink: "/transfer",
                        }}
                    />
...
export default withAuth(withRouter(TransferAdd));