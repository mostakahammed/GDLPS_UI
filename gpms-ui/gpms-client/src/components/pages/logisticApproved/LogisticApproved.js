...
import { faSearchDollar, faTicket, faVcard } from "@fortawesome/free-solid-svg-icons";
import withAuth from "../../../shared/hoc/AuthComponent";
import { withRouter } from "../../../shared/hoc/withRouter";
import { Helmet } from "react-helmet";

class LogisticApproved extends Component {
    constructor(props) {
        super(props);
        var today = new Date();
    ...
    getItems = async (pageNumber, pageSize = this.state.perPage) => {
        ...
        let filter = { pageNumber, pageSize, IsLogisticPage: true, SearchTerm: searchTerm, TransactionDate: this.state.date };
        this.setState({
            loading: true,
        });
        console.log(filter);
    ...
    render() {
        ...
        return (
            <div className="container-fluid">
                <Helmet>
                    <meta charSet="utf-8" />
                    <title>Logisitic Approved Carton</title>
                </Helmet>
                <Breadcrumb
                    BreadcrumbParams={{
                        header: "Total Logistic Carton Done",
                        title: "CartonDones",
...
export default withAuth(withRouter(LogisticApproved));
