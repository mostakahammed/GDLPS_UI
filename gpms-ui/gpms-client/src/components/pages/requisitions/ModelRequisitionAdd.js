...
export class ModelRequisitionAdd extends Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit = async (e) => {
        ...
        var { itemList, referenceNo, date, order, colorId, fromStoreId, toStoreId, reqStatus, viewItems, modelId, modelQty, specType } = this.state;
    ...
    render() {
        const { colors, order, colorId, status, types, suggestions, value, specType, date, referenceNo, viewItems, stores, fromStoreId, toStoreId, reqStatus, error, models, modelId, modelQty } = this.state;
        const inputProps = {
        ...
        return (
            <Fragment>
                <div className="container-fluid">
                    <Breadcrumb
                        BreadcrumbParams={{
                            header: "Model Wise Assembly Requisition",
...
export default withAuth(withRouter(ModelRequisitionAdd));