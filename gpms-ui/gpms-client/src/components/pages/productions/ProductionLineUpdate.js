...
export class ProductionLineUpdate extends Component {
    constructor(props) {
        super(props)
    ...
    handleInputChange = (event) => {
        ...
        if (name == "manpowerPresent") {
            ...
            var manpowerAbsent = manpowerAbsent;
    ...
    handleSubmit = async (e) => {
        ...
        const res = await ProductionLineService.AddLine(model, resToken.token);
...
export default withAuth(withRouter(ProductionLineUpdate));
